...
class CustomStanzaPipeline:
    def __init__(self, lang="de", processors=None, package="default", pretokenized=False, use_gpu=False):
        ...
        if self.lang == "de":
            self.tokenizer = stanza.Pipeline(
                lang="de", processors="tokenize,fix_ssplit", pretokenized=pretokenized, use_gpu=False
